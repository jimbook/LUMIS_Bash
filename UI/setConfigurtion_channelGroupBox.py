...
# Form implementation generated from reading ui file '.\setConfigurtion_channelGroupBox.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.doubleSpinBox_globalBias = QtWidgets.QDoubleSpinBox(Form)
        self.doubleSpinBox_globalBias.setMinimum(25.29)
        self.doubleSpinBox_globalBias.setMaximum(29.29)
        self.doubleSpinBox_globalBias.setProperty("value", 28.5)
        self.doubleSpinBox_globalBias.setObjectName("doubleSpinBox_globalBias")
        self.horizontalLayout_5.addWidget(self.doubleSpinBox_globalBias)
    ...
    def retranslateUi(self, Form):
        ...
        self.doubleSpinBox_globalBias.setSuffix(_translate("Form", "V"))
