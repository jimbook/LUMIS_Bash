...
if __name__ == '__main__':
    ...
    st = time.time()
    HitFile = 'testData/h5Data/tempData_10.27_14_12_02.h5'#"/Users/niqk/ownCloud/kemianqin/muon/Algorithm/8_layer_test/data/tempData_22_59_16.h5"  # background data
    ...
    from poca import POCA_Analysis as PCA
    pos = np.concatenate(result.POCA_List)
    Ana = POCA_Analysis()
    for i in pos:
        _df = i.reshape((12,))
        Ana.run_poca(_df)
